...
call_user_func(
    function()
    {
        ...
        \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addLLrefForTCAdescr('tx_pruebatpagaecommerce_domain_model_sale', 'EXT:prueba_tpaga_ecommerce/Resources/Private/Language/locallang_csh_tx_pruebatpagaecommerce_domain_model_sale.xlf');
        \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::allowTableOnStandardPages('tx_pruebatpagaecommerce_domain_model_sale');

        \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addLLrefForTCAdescr('tx_pruebatpagaecommerce_domain_model_idempotencykey', 'EXT:prueba_tpaga_ecommerce/Resources/Private/Language/locallang_csh_tx_pruebatpagaecommerce_domain_model_idempotencykey.xlf');
        \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::allowTableOnStandardPages('tx_pruebatpagaecommerce_domain_model_idempotencykey');
