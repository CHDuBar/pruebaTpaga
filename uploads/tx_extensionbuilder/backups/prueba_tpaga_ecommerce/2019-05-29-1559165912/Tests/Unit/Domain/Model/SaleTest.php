...
class SaleTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
     ...
     * @test
     */
    public function getCheckoutReturnsInitialValueForInt()
    {
        self::assertSame(
            0,
            $this->subject->getCheckout()
        );
    }
     ...
     * @test
     */
    public function setCheckoutForIntSetsCheckout()
    {
        $this->subject->setCheckout(12);
     ...
     * @test
     */
    public function getUserIpAddressReturnsInitialValueForString()
    {
        self::assertSame(
            '',
            $this->subject->getUserIpAddress()
        );
    }
     ...
     * @test
     */
    public function setUserIpAddressForStringSetsUserIpAddress()
    {
        $this->subject->setUserIpAddress('Conceived at T3CON10');
     ...
     * @test
     */
    public function getBuyerReturnsInitialValueForCustomer()
    {
        self::assertEquals(
            null,
     ...
     * @test
     */
    public function setBuyerForCustomerSetsBuyer()
    {
        $buyerFixture = new \CHDuBar\PruebaTpagaEcommerce\Domain\Model\Customer();
     ...
     * @test
     */
    public function getIdempotencyKeyReturnsInitialValueForIdempotencyKey()
    {
        self::assertEquals(
            null,
            $this->subject->getIdempotencyKey()
        );
    }
     ...
     * @test
     */
    public function setIdempotencyKeyForIdempotencyKeySetsIdempotencyKey()
    {
        $idempotencyKeyFixture = new \CHDuBar\PruebaTpagaEcommerce\Domain\Model\IdempotencyKey();
        $this->subject->setIdempotencyKey($idempotencyKeyFixture);
