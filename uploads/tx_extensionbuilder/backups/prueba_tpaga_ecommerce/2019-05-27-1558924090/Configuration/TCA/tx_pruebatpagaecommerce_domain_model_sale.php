...
return [
    'ctrl' => [
        ...
        'searchFields' => 'amount,link_pay,status,buyer,purchased_product',
        'iconfile' => 'EXT:prueba_tpaga_ecommerce/Resources/Public/Icons/tx_pruebatpagaecommerce_domain_model_sale.gif'
    ],
    'interface' => [
        'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, amount, link_pay, status, buyer, purchased_product',
    ],
    'types' => [
        '1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, amount, link_pay, status, buyer, purchased_product, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
        'sys_language_uid' => [
            'exclude' => true,
