...
module.tx_pruebatpagaecommerce_listadopedidos {
    view {
        # cat=module.tx_pruebatpagaecommerce_listadopedidos/file; type=string; label=Path to template root (BE)
        templateRootPath = EXT:prueba_tpaga_ecommerce/Resources/Private/Backend/Templates/
        # cat=module.tx_pruebatpagaecommerce_listadopedidos/file; type=string; label=Path to template partials (BE)
        partialRootPath = EXT:prueba_tpaga_ecommerce/Resources/Private/Backend/Partials/
        # cat=module.tx_pruebatpagaecommerce_listadopedidos/file; type=string; label=Path to template layouts (BE)
        layoutRootPath = EXT:prueba_tpaga_ecommerce/Resources/Private/Backend/Layouts/
    }
    persistence {
        # cat=module.tx_pruebatpagaecommerce_listadopedidos//a; type=string; label=Default storage PID
        storagePid =
    }
}
