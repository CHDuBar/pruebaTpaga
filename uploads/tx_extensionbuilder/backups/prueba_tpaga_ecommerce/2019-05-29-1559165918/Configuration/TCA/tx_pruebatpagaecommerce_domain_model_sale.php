...
return [
    'ctrl' => [
        ...
        'searchFields' => 'identifier,amount,link_pay,status,checkout,user_ip_address,buyer,purchased_product,idempotency_key',
        'iconfile' => 'EXT:prueba_tpaga_ecommerce/Resources/Public/Icons/tx_pruebatpagaecommerce_domain_model_sale.gif'
    ],
    'interface' => [
        'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, identifier, amount, link_pay, status, checkout, user_ip_address, buyer, purchased_product, idempotency_key',
    ],
    'types' => [
        '1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, identifier, amount, link_pay, status, checkout, user_ip_address, buyer, purchased_product, idempotency_key, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
        'sys_language_uid' => [
            'exclude' => true,
        ...
        'idempotency_key' => [
            'exclude' => true,
            'label' => 'LLL:EXT:prueba_tpaga_ecommerce/Resources/Private/Language/locallang_db.xlf:tx_pruebatpagaecommerce_domain_model_sale.idempotency_key',
            'config' => [
                'type' => 'inline',
