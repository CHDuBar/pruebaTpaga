...
class Sale extends \TYPO3\CMS\Extbase\DomainObject\AbstractEntity
{
    ...
    /**
     * Es el token de idempotencia único generado para la venta
     *
     * @var string
     * @validate NotEmpty
     */
    ...
    /**
     * Returns the idempotencyToken
     *
     * @return string $idempotencyToken
     */
    public function getIdempotencyToken()
    {
        return $this->idempotencyToken;
    }

    /**
     * Sets the idempotencyToken
     *
     * @param string $idempotencyToken
     * @return void
     */
    public function setIdempotencyToken($idempotencyToken)
    {
