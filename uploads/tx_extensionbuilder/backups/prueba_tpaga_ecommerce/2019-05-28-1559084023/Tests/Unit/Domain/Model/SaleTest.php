...
class SaleTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
     ...
     * @test
     */
    public function getIdempotencyTokenReturnsInitialValueForString()
    {
        self::assertSame(
            '',
            $this->subject->getIdempotencyToken()
        );
    }
     ...
     * @test
     */
    public function setIdempotencyTokenForStringSetsIdempotencyToken()
    {
        $this->subject->setIdempotencyToken('Conceived at T3CON10');
