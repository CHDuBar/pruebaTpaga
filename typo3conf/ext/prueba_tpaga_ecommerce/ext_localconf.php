...
call_user_func(
    function()
    {
        ...
        \TYPO3\CMS\Extbase\Utility\ExtensionUtility::configurePlugin(
            ...
            [
                ...
                'Sale' => 'list, show, new, create, revert, registerPurchase, '
            ],
    ...
    \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPageTSConfig(
        'mod {
            wizards.newContentElement.wizardItems.plugins {
                elements {
                    ...
                    payregister {
                        iconIdentifier = prueba_tpaga_ecommerce-plugin-payregister
                        title = LLL:EXT:prueba_tpaga_ecommerce/Resources/Private/Language/locallang_db.xlf:tx_prueba_tpaga_ecommerce_payregister.name
                        description = LLL:EXT:prueba_tpaga_ecommerce/Resources/Private/Language/locallang_db.xlf:tx_prueba_tpaga_ecommerce_payregister.description
                        tt_content_defValues {
                            CType = list
                            list_type = pruebatpagaecommerce_payregister
                        }
                    }
                }
                show = *
		...
		$iconRegistry = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance(\TYPO3\CMS\Core\Imaging\IconRegistry::class);
			...
			$iconRegistry->registerIcon(
				'prueba_tpaga_ecommerce-plugin-payregister',
				\TYPO3\CMS\Core\Imaging\IconProvider\SvgIconProvider::class,
				['source' => 'EXT:prueba_tpaga_ecommerce/Resources/Public/Icons/user_plugin_payregister.svg']
			);
