...
plugin.tx_pruebatpagaecommerce_payregister {
    view {
        templateRootPaths.0 = EXT:{extension.extensionKey}/Resources/Private/Templates/
        templateRootPaths.1 = {$plugin.tx_pruebatpagaecommerce_payregister.view.templateRootPath}
        partialRootPaths.0 = EXT:prueba_tpaga_ecommerce/Resources/Private/Partials/
        partialRootPaths.1 = {$plugin.tx_pruebatpagaecommerce_payregister.view.partialRootPath}
        layoutRootPaths.0 = EXT:prueba_tpaga_ecommerce/Resources/Private/Layouts/
        layoutRootPaths.1 = {$plugin.tx_pruebatpagaecommerce_payregister.view.layoutRootPath}
    }
    persistence {
        storagePid = {$plugin.tx_pruebatpagaecommerce_payregister.persistence.storagePid}
        #recursive = 1
    }
    features {
        #skipDefaultArguments = 1
...
module.tx_pruebatpagaecommerce_web_pruebatpagaecommercelistadooperaciones {
    persistence {
        storagePid = {$module.tx_pruebatpagaecommerce_listadooperaciones.persistence.storagePid}
    }
    view {
        templateRootPaths.0 = EXT:{extension.extensionKey}/Resources/Private/Backend/Templates/
        templateRootPaths.1 = {$module.tx_pruebatpagaecommerce_listadooperaciones.view.templateRootPath}
        partialRootPaths.0 = EXT:prueba_tpaga_ecommerce/Resources/Private/Backend/Partials/
        partialRootPaths.1 = {$module.tx_pruebatpagaecommerce_listadooperaciones.view.partialRootPath}
        layoutRootPaths.0 = EXT:prueba_tpaga_ecommerce/Resources/Private/Backend/Layouts/
        layoutRootPaths.1 = {$module.tx_pruebatpagaecommerce_listadooperaciones.view.layoutRootPath}
    }
}
