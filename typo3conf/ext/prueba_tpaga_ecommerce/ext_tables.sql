...
CREATE TABLE tx_pruebatpagaecommerce_domain_model_sale (
	...
	idempotency_key int(11) unsigned DEFAULT '0',
...
#
# Table structure for table 'tx_pruebatpagaecommerce_domain_model_idempotencykey'
#
CREATE TABLE tx_pruebatpagaecommerce_domain_model_idempotencykey (
