...
class Sale extends \TYPO3\CMS\Extbase\DomainObject\AbstractEntity
{
    ...
    function __construct($saleInit, $customer, $product, $idempotencyKey)
    {
        ...
        $number_checkout = random_int(1, 5);
        $checkout = 'caja_' . $number_checkout;
        ...
        $billing_number = random_int(100, 999);
        $this->setIdentifier(date("Y").date("m").date("d").$number_checkout.$billing_number);
    }
